...
class Day22Test {
    ...
    inner class Part1 {
        ...
        fun `Matches Sample Data`() {
            val answer = Day22(part1Sample).solvePart1()
            assertThat(answer).isEqualTo(590784L)
        }

        @Test
        fun `Matches Actual Data`() {
            val answer = Day22(resourceAsListOfString("day22.txt")).solvePart1()
            assertThat(answer).isEqualTo(652209L)
        }
    }
    ...
    inner class Part2 {
        @Test
        fun `Matches Sample Data`() {
            val answer = Day22(part2Sample).solvePart2()
        ...
        fun `Matches Actual Data`() {
            ...
            assertThat(answer).isEqualTo(1217808640648260L)
        }
    }
}